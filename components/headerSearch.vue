  ...
  <view :style="{height: navOpt.height}">
    ...
    >
      <view
        ...
        :style="{marginTop: navOpt.top, textAlign: pageOpt.pageTitleAlign, paddingLeft: pageOpt.pageTitleMarginSize, color: pageOpt.pageTitleColor}"
      >
        <view class="position-absolute d-flex align-items-center left-btn-content">
          <view
            class="iconfont mr-20 icon-btn"
            v-if="!initOptions.isTabPage === true"
            @click="handleRouterBack"
          >
            <image class="imgCover" src="/static/icon/com_back_bgF5.png" />
          </view>
        </view>
        <view class="position-absolute d-flex align-items-center search-bar">
          <view class="ml-10 iconfont">
            <image class="imgCover" src="/static/icon/class_search_bgF.png" />
          </view>
          <input
            type="text"
            class="col ml-10 mr-20 input"
            v-model="initOptions.keywords"
            :placeholder="initOptions.placeholder || '搜索'"
